        ...
        <?php foreach($ponentes as $ponente){ ?>
            <div class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo $_ENV['APP_URL'] . '/img/speakers/' . $evento->ponente->imagen; ?>.png" alt="Imagen ponente">
                </picture>
